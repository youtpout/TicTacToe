...
function Home() {
    ...
    const GODOT_CONFIG = {
        ...
        "executable": "GodotMina",
        "experimentalVK": false,
        "fileSizes": {
            "GodotMina.pck": 18538448,
            "GodotMina.wasm": 18795755
        },
        "focusCanvas": true,
        "gdnativeLibs": []
    };
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        ...
        if (state.accountExists && win.tictactoe) {
            var _state_publicKey, _state_publicKey1, _win_tictactoe_game, _win_tictactoe;
            console.log("acc", (_state_publicKey = state.publicKey) === null || _state_publicKey === void 0 ? void 0 : _state_publicKey.toBase58());
            win.tictactoe.account = (_state_publicKey1 = state.publicKey) === null || _state_publicKey1 === void 0 ? void 0 : _state_publicKey1.toBase58();
            (_win_tictactoe = win.tictactoe) === null || _win_tictactoe === void 0 ? void 0 : (_win_tictactoe_game = _win_tictactoe.game) === null || _win_tictactoe_game === void 0 ? void 0 : _win_tictactoe_game.startGame().then();
        }
    }, [
        state.accountExists
    ]);
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        ...
        (async ()=>{
            if (!state.hasBeenSetup) {
                ...
                const zkappPublicKey = o1js__WEBPACK_IMPORTED_MODULE_4__/* .PublicKey */ .nh.fromBase58("B62qrMWbGSH5Lky7P6c9Wre23xBBTRJUG6TNpZrLQVqJdW4m5uaHHdC");
                const zkappSavePublicKey = o1js__WEBPACK_IMPORTED_MODULE_4__/* .PublicKey */ .nh.fromBase58("B62qkR9Har8apahum18KggGtHbAiumoQ65b6uH4vukaqdh3LZCA9jt5");
    ...
    const onSendTransaction = async (gameState, signGame, hashGame)=>{
        ...
        var player2 = o1js__WEBPACK_IMPORTED_MODULE_4__/* .PublicKey */ .nh.fromBase58("B62qnL3MYoZcmppsLqR7XjS5tAgs3ErMGjM8aL6UpE3tvt5bC23fWo6");
        var oldState = JSON.parse(gameState);
        const { GameState } = await __webpack_require__.e(/* import() */ 223).then(__webpack_require__.bind(__webpack_require__, 3270));
        const newGameState = new GameState({
            board: o1js__WEBPACK_IMPORTED_MODULE_4__/* .Field */ .gN.from(oldState.Board),
            player1: player1,
            player2: player2,
            nextIsPlayer2: (0,o1js__WEBPACK_IMPORTED_MODULE_4__/* .Bool */ .tW)(true),
            startTimeStamp: o1js__WEBPACK_IMPORTED_MODULE_4__/* .UInt64 */ .zM.from(oldState.StartTimeStamp)
        });
        ...
        const signResult = await ((_win_mina = win.mina) === null || _win_mina === void 0 ? void 0 : _win_mina.signFields(signContent));
